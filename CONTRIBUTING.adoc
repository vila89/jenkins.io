...
The purpose of this guide is to provide instructions on how to get set up to
contribute to `jenkins.io`, as well as how to edit and review content on this
site. Since this site is generated using a combination of Asciidoctor and
Awestruct, this CONTRIBUTING guide covers aspects of AsciiDoc and Haml syntax
and usage which are required for this site to function correctly. This guide,
however, is not a detailed guide on how to use AsciiDoc and Haml syntax.

For details about Jenkins-specific terminology, writing style and using AsciiDoc
syntax correctly on this site, see the link:STYLEGUIDE.adoc[STYLEGUIDE].
