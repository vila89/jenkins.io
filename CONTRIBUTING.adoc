...
contribute to `jenkins.io`, as well as how to edit/contribute content on this
site. Since this site is generated using a combination of Asciidoctor and
Awestruct, this guide covers various aspects of AsciiDoc and Haml syntax which
are important for creating properly functioning content on this site. This
guide, however, does not provide details on AsciiDoc and Haml syntax.

For details about Jenkins-specific terminology, writing style and using AsciiDoc
syntax on this site, see the link:STYLEGUIDE.adoc[STYLEGUIDE].
