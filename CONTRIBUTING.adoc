...
are important for creating properly functioning content on this site. However,
this guide does not provide details on AsciiDoc and Haml syntax.

For details about Jenkins-specific terminology, writing style and using AsciiDoc
syntax on this site, see the link:styleguide[STYLEGUIDE].
